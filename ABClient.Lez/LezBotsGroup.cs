...
[Serializable]
public class LezBotsGroup : ICloneable, IComparable
{
	public int Id;
	...
	{
		LezBotsGroup lezBotsGroup = (LezBotsGroup)obj;
		int num = lezBotsGroup.Id.CompareTo(Id);
		if (num != 0)
		{
			return num;
		}
		return lezBotsGroup.MinimalLevel.CompareTo(MinimalLevel);
	}

	public object Clone()
	{
		return Misc.DeepClone(this);
	}
}
